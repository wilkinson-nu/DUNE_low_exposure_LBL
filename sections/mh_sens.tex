...
\begin{figure*}[htbp]
  ...
  \caption{Fraction of throws for which the DUNE sensitivity to the mass hierarchy exceeds 1--5$\sigma$ significance, as a function of the true value of \deltacp. Shown for \dword{no}, for a number of different exposures. The number of throws used to make each figure is also shown.}
