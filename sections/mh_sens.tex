...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\linewidth, trim={0cm 0cm 0cm 2.3cm}, clip]{mh_two_exps_throws_nh_2019_v4_lowexp_prdunits.png}
  \includegraphics[width=1\linewidth, trim={0cm 0cm 0cm 2.3cm}, clip]{mh_two_exps_throws_ih_2019_v4_lowexp_prdunits.png}
...
\begin{figure*}[htbp]
  \centering
  \subfloat[6 kt-MW-yr]   {\includegraphics[width=0.33\linewidth]{MH_comp_ndfd_6ktMWyr_th13_prdunits.png}}
  \subfloat[12 kt-MW-yr]  {\includegraphics[width=0.33\linewidth]{MH_comp_ndfd_12ktMWyr_th13_prdunits.png}}
  \subfloat[24 kt-MW-yr]  {\includegraphics[width=0.33\linewidth]{MH_comp_ndfd_24ktMWyr_th13_prdunits.png}}\\
  \subfloat[66 kt-MW-yr]  {\includegraphics[width=0.33\linewidth]{MH_comp_ndfd_66ktMWyr_th13_prdunits.png}}
  \subfloat[100 kt-MW-yr] {\includegraphics[width=0.33\linewidth]{MH_comp_ndfd_100ktMWyr_th13_prdunits.png}}
  \subfloat[336 kt-MW-yr] {\includegraphics[width=0.33\linewidth]{MH_comp_ndfd_336ktMWyr_th13_prdunits.png}}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\linewidth]{fraction_throws_vs_exp_wrong_ordering_prdunits.pdf}
...
\begin{figure*}[htbp]
  \centering
  \subfloat[6 kt-MW-yr]   {\includegraphics[width=0.33\linewidth]{mh_throws_6ktMWyr_NH_th13_prdunits.png}}
  \subfloat[12 kt-MW-yr]  {\includegraphics[width=0.33\linewidth]{mh_throws_12ktMWyr_NH_th13_prdunits.png}}
  \subfloat[24 kt-MW-yr]  {\includegraphics[width=0.33\linewidth]{mh_throws_24ktMWyr_NH_th13_prdunits.png}}\\
  \subfloat[66 kt-MW-yr]  {\includegraphics[width=0.33\linewidth]{mh_throws_66ktMWyr_NH_th13_prdunits.png}}
  \subfloat[100 kt-MW-yr] {\includegraphics[width=0.33\linewidth]{mh_throws_100ktMWyr_NH_th13_prdunits.png}}
  \subfloat[336 kt-MW-yr] {\includegraphics[width=0.33\linewidth]{mh_throws_336ktMWyr_NH_th13_prdunits.png}}
