...
\begin{figure*}[h]
  ...
  \subfloat[24 kt-MW-years] {\includegraphics[width=0.33\linewidth]{nh_FC_ndfd_24ktMWyr_dcp0.png}}
  \subfloat[66 kt-MW-years] {\includegraphics[width=0.33\linewidth]{nh_FC_ndfd_66ktMWyr_dcp0.png}}
  \subfloat[100 kt-MW-years]{\includegraphics[width=0.33\linewidth]{nh_FC_ndfd_100ktMWyr_dcp0.png}}\\
  \subfloat[150 kt-MW-years]{\includegraphics[width=0.33\linewidth]{nh_FC_ndfd_150ktMWyr_dcp0.png}}
  \subfloat[197 kt-MW-years]{\includegraphics[width=0.33\linewidth]{nh_FC_ndfd_197ktMWyr_dcp0.png}}
  \subfloat[336 kt-MW-years]{\includegraphics[width=0.33\linewidth]{nh_FC_ndfd_334ktMWyr_dcp0.png}}\\
  \subfloat[500 kt-MW-years]{\includegraphics[width=0.33\linewidth]{nh_FC_ndfd_500ktMWyr_dcp0.png}}
  \subfloat[646 kt-MW-years]{\includegraphics[width=0.33\linewidth]{nh_FC_ndfd_646ktMWyr_dcp0.png}}
  \subfloat[936 kt-MW-years]{\includegraphics[width=0.33\linewidth]{nh_FC_ndfd_936ktMWyr_dcp0.png}}
...
\begin{figure*}[h]
  ...
  \caption{Distribution of \dchisq values, calculated using Equation~\ref{eq:dchisq_fc}, for a large number of throws for 9 different values of true \deltacp, for a 100 kt-MW-years exposure. The \dchisqcrit values (vertical lines) obtained using the Feldman-Cousins method show the \dchisq value below which 68.27\% (1$\sigma$), 90\%, 95.45\% (2$\sigma$) and 99.73\% (3$\sigma$) of throws reside, with the calculated values given in the legend. The number of throws used is also given.}
  \label{fig:fc_throws_100kt-MW-years}
\end{figure*}
\begin{figure*}[h]
  \centering
  ...
  \caption{Distribution of \dchisq values, calculated using Equation~\ref{eq:dchisq_fc}, for a large number of throws for 9 different values of true \deltacp, for a 334 kt-MW-years exposure. The \dchisqcrit values (vertical lines) obtained using the Feldman-Cousins method show the \dchisq value below which 68.27\% (1$\sigma$), 90\%, 95.45\% (2$\sigma$) and 99.73\% (3$\sigma$) of throws reside, with the calculated values given in the legend. The number of throws used is also given.}
  \label{fig:fc_throws_334kt-MW-years}
\end{figure*}
The distribution of throws used to calculate the \dchisqcrit values for Figure~\ref{fig:fc_vs_exp} for nine different exposures with $\deltacp = 0$ are shown in Figure~\ref{fig:fc_throws_exp}; for Figure~\ref{fig:fc_vs_dcp_100} for nine different values of \deltacp with an exposure of 100 kt-MW-years in Figure~\ref{fig:fc_throws_100kt-MW-years}; and for Figure~\ref{fig:fc_vs_dcp_334} for nine different values of \deltacp with an exposure of 334 kt-MW-years in Figure~\ref{fig:fc_throws_334kt-MW-years}. For each distribution shown in Figures~\ref{fig:fc_throws_exp},~\ref{fig:fc_throws_100kt-MW-years} and~\ref{fig:fc_throws_334kt-MW-years}, the calculated \dchisqcrit values corresponding to for 68.27\% (1$\sigma$), 90\%, 95.45\% (2$\sigma$) and 99.73\% (3$\sigma$) of the throws are given and indicated with a vertical line. The number of throws used is also given. The \dchisqcrit values were only calculated up to the 3$\sigma$ level due to the very large number of throws required for higher confidence levels.
