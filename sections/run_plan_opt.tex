...
\begin{equation}
  \Delta\chi^{2}_{\mathrm{CPV}} = \min\left\{\chi^{2}_{\deltacp = 0},\chi^{2}_{\deltacp = \pm\pi}\right\} - \chi^{2}_{\mathrm{CPV}},
  \label{eq:cpv_chi2}
\end{equation}
...
\begin{equation}
  \Delta\chi^{2}_{\mathrm{MO}} = \chi^{2}_{\mathrm{IO}} - \chi^{2}_{\mathrm{NO}},
  \label{eq:mh_chi2}
\end{equation}
